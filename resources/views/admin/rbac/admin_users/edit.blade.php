                ...
                <form class="form-horizontal layui-form" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="true_name" name="true_name" value="{{ $user->true_name }}" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="email" name="email" value="{{ $user->email }}" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="menu_name" class="layui-form-label">
                            <span class="x-red">*</span>手机号</label>
                        <div class="layui-input-inline">
                            <input type="text" id="phone" name="phone" value="{{ $user->phone }}" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="menu_name" class="layui-form-label">
                            <span class="x-red">*</span>密码</label>
                        <div class="layui-input-inline">
                            <input type="text" id="password" placeholder="不修改密码则无需填写" name="password" value="" required=""  autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <input type="hidden" name="url" value="{{ route('admin.admin_user.update',['id'=>$user->id]) }}">
                    <div class="layui-form-item">
        ...
        <script>layui.use(['form', 'layer','jquery','laydate'],
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                        type:'post',
                        data:{true_name:true_name,email:email,phone:phone,password:password,roles:roles,is_super:is_super,id:id,_method:_method},
                        dataType:'json',
                        url:url,
